...
export interface IHydraS1VerifierInterface extends utils.Interface {
  functions: {
...
export interface IHydraS1Verifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IHydraS1VerifierInterface;
